...
import { fetchPatientsRequest, setCurrentPatient, clearCurrentPatient } from '../../store/slices/patientSlice';
...
const Patients = () => {
  ...
  const { patients, fetchLoading } = useSelector(state => state.patients);
